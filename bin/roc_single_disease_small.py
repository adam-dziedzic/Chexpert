...
parser.add_argument('--true_csv_path',
                    ...
                    # default=f'/home/{user}/data/CheXpert-v1.0-small/train.csv',
...
parser.add_argument('--base_name', default='roc_plot', metavar='BASE_NAME',
...
def read_csv(csv_path, true_csv=False):
    image_paths = []
    probs = []
    dict_ = [{'1.0': '1', '': '0', '0.0': '0', '-1.0': '0', 'Unknown': '0'},
             {'1.0': '1', '': '0', '0.0': '0', '-1.0': '1', 'Unknown': '0'}, ]
...
def run(args):
    ...
    plt.grid()
    plt.savefig(
        os.path.join(args.plot_path, args.base_name + '_roc.png'),
        bbox_inches='tight')
